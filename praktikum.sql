...
-- Dumping structure for table praktikum.bagian
...
-- Dumping data for table praktikum.bagian: ~3 rows (approximately)
...
-- Dumping structure for table praktikum.bagian_karyawan
...
-- Dumping data for table praktikum.bagian_karyawan: ~6 rows (approximately)
...
-- Dumping structure for table praktikum.jabatan
...
-- Dumping data for table praktikum.jabatan: ~5 rows (approximately)
...
-- Dumping structure for table praktikum.jabatan_karyawan
...
-- Dumping data for table praktikum.jabatan_karyawan: ~17 rows (approximately)
...
-- Dumping structure for table praktikum.karyawan
...
-- Dumping data for table praktikum.karyawan: ~8 rows (approximately)
...
-- Dumping structure for table praktikum.lokasi
...
-- Dumping data for table praktikum.lokasi: ~3 rows (approximately)
...
-- Dumping structure for table praktikum.penggajian
...
-- Dumping data for table praktikum.penggajian: ~18 rows (approximately)
...
-- Dumping structure for table praktikum.pengguna
...
-- Dumping data for table praktikum.pengguna: ~8 rows (approximately)
...
-- Dumping structure for table praktikum.presensi
...
-- Dumping data for table praktikum.presensi: ~552 rows (approximately)
